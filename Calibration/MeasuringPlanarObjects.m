...
files{i} = fullfile( 'Courses', 'Leap motion project', 'camera control', ...
        'improcessing', 'Calibration', sprintf('IMG_%d.JPG', i));
end
...
imOrig = imread(fullfile('Courses', 'Leap motion project', 'camera control', ...
        'improcessing', 'Calibration', 'IMG_15.JPG'));
